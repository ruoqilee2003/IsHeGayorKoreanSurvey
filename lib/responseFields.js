...
export const ARRAY_FIELDS = ["q2b", "fields", "factors", "cp_orient"];
...
export function buildTallies(records) {
  ...
  const cpOrientCounts = {};
  for (const r of records) {
    for (const o of r.cp_orient || []) {
      cpOrientCounts[o] = (cpOrientCounts[o] || 0) + 1;
    }
  }
  tallies.cp_orient = { label: "\u95DC\u6CE8\u7684\u89D2\u8272\u6200\u611B\u6027\u5411\u95DC\u4FC2\uFF08\u8907\u9078\uFF09", counts: cpOrientCounts };
  return tallies;
}
